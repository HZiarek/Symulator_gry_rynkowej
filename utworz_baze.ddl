...
CREATE TABLE dostepy_producentow_his_zakup (
    id_konsumenta      NUMBER(8) NOT NULL,
    numer_rundy        NUMBER(5) NOT NULL,
    id_badania_rynku   NUMBER(6) NOT NULL
);
...
CREATE TABLE ustawienia_poczatkowe (
    ...
    marketing_koszt_per_st_intens    NUMBER(8) NOT NULL,
    wplyw_marketingu_producenta      NUMBER(3,2) NOT NULL,
...
COMMENT ON COLUMN ustawienia_poczatkowe.marketing_koszt_per_st_intens IS
