...
ALTER TABLE hipotetyczna_marka
    ADD CONSTRAINT hipo_mar_producent_fk FOREIGN KEY ( producent_id_producenta )
        REFERENCES producent ( id_producenta );

ALTER TABLE hipotetyczna_marka
    ADD CONSTRAINT hipo_mar_rodzaje_marek_fk FOREIGN KEY ( rodzaje_marek_jakosc_marki )
...
ALTER TABLE ocena_hipotetycznej_marki
    ADD CONSTRAINT oc_hipo_hipotetyczna_marka_fk FOREIGN KEY ( id_hipotetycznej_marki )
        REFERENCES hipotetyczna_marka ( id_hipotetycznej_marki );

ALTER TABLE ocena_hipotetycznej_marki
    ADD CONSTRAINT oc_hipo_konsument_fk FOREIGN KEY ( konsument_id_konsumenta )
        REFERENCES konsument ( id_konsumenta );

ALTER TABLE ocena_hipotetycznej_marki
    ADD CONSTRAINT oc_hipo_marki_badanie_rynku_fk FOREIGN KEY ( badanie_rynku_id_badania_rynku )
        REFERENCES badanie_rynku ( id_badania_rynku );
